...
const FEATURES: FeatureItem[] = [
  {
    id: 'services',
    icon: LayoutGrid,
    title: 'Concept to software execution.',
    description: 'Get tailored architectural delivery from senior systems engineers utilizing Claude Code, Codex, PHP, JavaScript, and modern test-driven development.',
    linkText: 'View development pipeline',
    action: 'pipeline',
  },
  {
    id: 'certifications',
    icon: Users,
    title: 'Securiti-certified engineering.',
    description: 'Work with a validated systems architect specializing in secure API design, OWASP LLM firewalls, and NIST AI RMF standards (Cert ID: 14B411BCE-14B411A3D-1451CFE76).',
  ...
  },
  {
    id: 'retainers',
    icon: MessageSquare,
    title: 'Automated retest & iteration.',
    description: 'Receive continuous verification, automated unit and integration test suites, regression re-testing on every update, and zero breaking changes.',
    linkText: 'View execution logs & test history',
    action: 'logs',
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-10">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] text-[var(--color-text-primary)]">
            Powering modern software builds.{' '}
            <span className="text-[var(--color-text-secondary)] opacity-75 font-normal">
              Deliver robust software with autonomous AI tools and rigorous automated test verification.
            </span>
          </h2>
        </div>
